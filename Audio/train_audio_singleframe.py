...
def main():
    ...
    parser.add_argument('--pretrained', default = 1, type = int, help = 'Freeze VGG weights')
    ...
    import numpy as np
    from models_audio import pretrained_vggish_volumetric_FPN
    from dataloader_audio_volume import DataGenerator_vol
    ...
    train_generator = DataGenerator_vol(IDs_train, dim = (96,64), batch_size = args.batch_size, train = True, delay = args.delay)
    val_generator = DataGenerator_vol(IDs_val, dim = (96,64), batch_size = args.batch_size, train = False, delay = args.delay)
    ...
    model = pretrained_vggish_volumetric_FPN() #
